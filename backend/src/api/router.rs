use crate::api::{
    ...
    health, indexing, knowledge, projects, rag, research, settings, system_admin, workflows,
};
    ...
    Router::new()
        ...
        .push(
            Router::with_path(API_PREFIX)
                ...
                .push(content::router())
                .push(dashboard::router())
                .push(departments::router())
                .push(knowledge::router())
                .push(projects::router())
                .push(rag::router())
                .push(health::router())
                .push(admin::router())
                .push(graph::router())
